	...
	render() {
		return (
            ...
            <OrderContainer>
                ...
                <InfoRowContainer>
                    <InfoRowText><TextCustom  small grey>N°COMMANDE</TextCustom></InfoRowText>
                ...
                <InfoRowContainer>
                    <InfoRowText><TextCustom  small grey>COMMANDÉ POUR LE</TextCustom></InfoRowText>
                ...
                <InfoRowContainer style={{marginBottom: 5}}>
                    <InfoRowText><TextCustom  small grey>POUR LE</TextCustom></InfoRowText>
                ...
                <TotalContainer style={{marginTop: 50, justifyContent: 'space-evenly'}}>
                    <Button primary outlined>Modifier</Button>
                    <Button alerte outlined>Annuler</Button>
                </TotalContainer>
