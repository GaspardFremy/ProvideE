            ...
            headerLeft: (
                <TouchableWithoutFeedback onPress={() => navigation.goBack()}>
                    <HeaderContainer>
                        ...
                        <TextContainer>
                            <TextCustom title white>Moyens de paiement</TextCustom>
                        </TextContainer>
                    </HeaderContainer>
		...
		return (
            ...
            <Container grey flex padding={1}>
                ...
                <View style={{marginBottom: 10}}>
                    <Button onPress={() => console.log(this.props.navigation.navigate('AddPayment'))}>Ajouter un moyen de paiement</Button>
                </View>
